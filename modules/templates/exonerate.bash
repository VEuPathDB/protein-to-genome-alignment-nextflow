...
do
 ...
 if echo version >/dev/tcp/localhost/\$EXONERATE_EXONERATE_SERVER_PORT; then
   ...
   exonerate --fsmmemory $fsmMemory -n 1 --geneseed 250 -S n  --minintron 20 --maxintron $maxIntron  --showcigar n --showvulgar n --showalignment n --showtargetgff y --model protein2genome --query $queryFile --target localhost:\$EXONERATE_EXONERATE_SERVER_PORT >alignments.gff
